...
Before proceeding, make sure to first read [Using a Custom Theme](/guide/customization/custom-theme/) to understand how custom themes work.
{% </tip> %}
...
```vue,name=.vitepress/theme/MyLayout.vue
<script setup>
import DefaultTheme from 'vitepress/theme'
