...
Since [`Theme.enhanceApp`](/guide/customization/custom-theme/#theme-interface) can be async, you can conditionally import and register Vue plugins that access browser APIs on import:
