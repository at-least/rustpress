...
| Option                         | Description                                                                                                         |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------- |
| `--mpa` (experimental)         | Build in [MPA mode](/guide/experimental/mpa-mode/) without client-side hydration (`boolean`)                                    |
| `--base <path>`                | Public base path (default: `/`) (`string`)                                                                          |
...
Start the [Setup Wizard](/guide/introduction/getting-started/#setup-wizard) in current directory.
