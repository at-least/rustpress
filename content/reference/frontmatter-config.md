...
Specify extra head tags to be injected for the current page. They are [merged](/reference/site-config/#head) with the head tags injected by site-level config.
...
### hero <span class="VPBadge info">home page only</span>
...
### features <span class="VPBadge info">home page only</span>
...
Whether to display [navbar](/reference/default-theme/nav/).
...
Whether to display [sidebar](/reference/default-theme/sidebar/).
...
The levels of header in the outline to display for the page. It's same as [config.themeConfig.outline.level](/reference/default-theme/config/#outline), and it overrides the value set in site-level config.
...
Whether to display [last updated](/reference/default-theme/last-updated/) text in the footer of the current page. If a datetime is specified, it will be displayed instead of the last git modified timestamp.
...
Whether to display [edit link](/reference/default-theme/edit-link/) in the footer of the current page.
...
Whether to display [footer](/reference/default-theme/footer/).
