...
The configuration for the nav menu item. More details in [Default Theme: Nav](/reference/default-theme/nav/#navigation-links).
...
The configuration for the sidebar menu item. More details in [Default Theme: Sidebar](/reference/default-theme/sidebar/).
...
- Type: `boolean | 'left'`
- Default: `true`
- Can be overridden per page via [frontmatter](/reference/frontmatter-config/#aside)
...
- Level can be overridden per page via [frontmatter](/reference/frontmatter-config/#outline)
...
- Type: `Footer`
- Can be overridden per page via [frontmatter](/reference/frontmatter-config/#footer)
...
- Type: `EditLink`
- Can be overridden per page via [frontmatter](/reference/frontmatter-config/#editlink)

Edit Link lets you display a link to edit the page on Git management services such as GitHub, or GitLab. See [Default Theme: Edit Link](/reference/default-theme/edit-link/) for more details.
...
An option to support searching your docs site using [Algolia DocSearch](https://docsearch.algolia.com/docs/what-is-docsearch). Learn more in [Default Theme: Search](/reference/default-theme/search/)
...
Learn more in [Default Theme: Carbon Ads](/reference/default-theme/carbon-ads/)

## docFooter

- Type: `DocFooter`

Can be used to customize text appearing above previous and next links. Helpful if not writing docs in English. Also can be used to disable prev/next links globally. If you want to selectively enable/disable prev/next links, you can use [frontmatter](/reference/default-theme/prev-next-links/).
...
Can be used to customize the aria-label of the language toggle button in navbar. This is only used if you're using [i18n](/guide/writing/i18n/).
...
Whether to color [custom containers](/guide/writing/markdown/#custom-containers), [GitHub-flavored alerts](/guide/writing/markdown/#github-flavored-alerts), and badges on a graded severity scale — danger red, warning orange, caution yellow. By default, colors match GitHub's alerts, where caution shares danger's red and warning is yellow.

## `useLayout` <span class="VPBadge info">composable</span>
