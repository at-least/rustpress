...
An unknown name fails the build and lists the available palettes. Source-code colors are a separate setting — see [`[syntax]`](#syntax). The [Theming](../guide/theming) guide covers both.
