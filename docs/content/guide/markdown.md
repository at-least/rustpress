...
The colors come from a pair of Helix TOML themes (light/dark), selected in the `[syntaxHighlight]` section of `rustpress.toml`; all 218 themes bundled with the Helix editor are available by name. See [Theming](./coming-from-vitepress#theming).
