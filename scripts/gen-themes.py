...
SPECS = [
 ...
 dict(name="gruvbox", desc="retro groove, warm cream and charcoal",
      light=dict(f="gruvbox_light", m=dict(bg="bg0", bg_alt="bg1", bg_elv="bg2",
 ...
 dict(name="gruvbox-material", desc="the material take on gruvbox, softer and calmer",
      light=dict(f="gruvbox_material_light_medium", m=dict(bg="bg0", bg_alt="bg1", bg_elv="bg2",
 ...
 dict(name="everforest", desc="green, calm and low-noise by design",
      light=dict(f="everforest_light", m=dict(bg="bg0", bg_alt="bg1", bg_elv="bg2",
 ...
 dict(name="solarized", desc="the classic: selective contrast, warm and marine",
      light=dict(f="solarized_light", m=dict(bg="base03", bg_alt="base02", bg_elv="base025",
 ...
 dict(name="kanagawa", desc="wave and lotus: ink, sumi and ukiyo-e color",
      light=dict(f="kanagawa-lotus", m=dict(bg="lotusWhite0", bg_alt="lotusWhite1", bg_elv="lotusWhite2",
 ...
 dict(name="papercolor", desc="plain paper, high legibility, 16-color spirit",
      light=dict(f="papercolor-light", m=dict(bg="background", bg_alt="#e0e0e0", bg_elv="cursorline_secondary_bg",
 ...
 dict(name="iceberg", desc="cool navy-blue calm, light and dark",
      light=dict(f="iceberg-light", m=dict(bg="background_bg", bg_alt="sel_bg", bg_elv="statusline_bg",
